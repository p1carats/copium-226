...
export default class TemplateDialogue extends Phaser.Scene {
	...
	create() {
		...
		let pauseButton: Phaser.GameObjects.Sprite = this.add.sprite(50, 50, Textures.PauseButton).setOrigin(0).setInteractive();
		...
		pauseButton.on('pointerdown', () => {
			clickedSound.play();
			roomMusic.pause();
			/*let postFxPlugin = this.plugins.get('rexKawaseBlurPipelinePlugin') as KawaseBlurPipelinePlugin;
