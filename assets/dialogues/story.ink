...
VAR isMiniGame3Won = false
VAR isQuotaRespected = false
...
# location=void
// 2 mois plus tard (timeskip, à implémenter !)
...
[M. Vermeil] Craig Vermeil. Directeur de la branche de Green Horizon installée à Vitry-la-Vallée.
Green Horizon...
...
+ [Comment comptez-vous améliorer le réseau électrique du village ?]
	[M. Vermeil] Nous devons encore mener quelques enquêtes sur le terrain, mais notre plan A serait la construction d'un barrage hydraulique sur la rivière proche. L'énergie produite devrait être suffisante pour alimenter la ville durant sa croissance, pendant que nous construirons en parallèle une centrale nucléaire.
	[George] Une centrale nucléaire !? N'est pas un peu... excessif ?
	[M. Vermeil] Il semblerait que vous sous-estimez encore la valeur du Copium 226, M. Beauvois. C'est ma conviction la plus forte que Vitry-la-Vallée va devenir l'une des métropole les plus importantes du monde dans les décennies qui arrivent. Une centrale nucléaire est le strict minimum.
	-> CHOICE_GH
...
{
- !isMiniGame3Won:
	[M. Vermeil] Je n'ai pas envie de faire ça M. Beauvois, mais je n'ai pas le choix.
	Aïe. Ça commence mal.
...
- isQuotaRespected:
	...
	* [Je suis désolé, je ne peux pas ce soir...]
		...
		[George] Très bien. Passez une bonne soirée M. Vermeil.
		# location=void
...
- else:
	...
	[M. Vermeil] Continue le bon boulot.
	[George] Oui monsieur.
	# location=void
	Je m'enfuie du bureau aussi vite que la politesse le permet.
	Une fois dans le couloir je me pince l'avant bras.
	[George] Aïe.
	Non, je ne suis pas en train d'halluciner. M. Vermeil vient vraiment de me complimenter et de m'appeler par mon prénom dans la même minute.
...
* [Vous pourriez venir le boire vous même.]
	...
	{
	- isQuotaRespected:
		[George] Ah je vois, c'est dom... Attendez !
		[George] Le rapport de production du dernier mois ? Mais... je vous l'ai envoyé par mail il y a 3 jours !
		[Amber] Aaah ?
...
- georgeRelationAmber:
	...
	* [Très bien, j'arrive au bunker.]
		[Amber] Vraiment ?
		[George] Oui. Moi aussi je t'aime... C'est ce que tu voulais non ? Ne paraît pas aussi surprise s'il te plait.
